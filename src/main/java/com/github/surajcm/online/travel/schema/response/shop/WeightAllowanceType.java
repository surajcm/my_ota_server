 ...
 *         <element name="MaximumWeightMeasure" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}MeasureType"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "WeightAllowanceType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", propOrder = {
    "applicableBagText",
    "applicablePartyText",
    "descText",
...
public class WeightAllowanceType {
     ...
     * 
     */
    @XmlElement(name = "MaximumWeightMeasure", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", required = true)

 ...
 *         <element name="FareBasisAppCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}CodeType" minOccurs="0"/>
 *         <element name="FareBasisCityPairText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}TextType" minOccurs="0"/>
 *         <element name="FareBasisCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}CodeType" minOccurs="0"/>
 *         <element name="FareRule" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}FareRuleType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FareTypeCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}CodeType" minOccurs="0"/>
 *         <element name="NegotiatedCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}CodeType" minOccurs="0"/>
 *         <element name="PaxSegmentRefID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}ID_Type" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Price" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}PriceType" minOccurs="0"/>
 *         <element name="PriceClassRefID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}ID_Type" minOccurs="0"/>
 *         <element name="RBD" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}RBD_Type" minOccurs="0"/>
 *         <element name="TicketDesigCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}TextType" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "FareComponentType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", propOrder = {
    "cabinType",
    "fareBasisAppCode",
...
public class FareComponentType {
     ...
     * 
     */
    @XmlElement(name = "FareBasisAppCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
     ...
     * 
     */
    @XmlElement(name = "FareBasisCityPairText", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    protected String fareBasisCityPairText;
    /**
     * Fare basis code. Example: Y26
     * 
     */
    @XmlElement(name = "FareBasisCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "FareRule", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
     ...
     * 
     */
    @XmlElement(name = "FareTypeCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "NegotiatedCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "RBD", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
     ...
     * 
     */
    @XmlElement(name = "TicketDesigCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")

 ...
 *       <sequence>
 *         <element name="AccountCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}CodeType" minOccurs="0"/>
 *         <element name="FareComponent" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}FareComponentType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FareIndCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}CodeType" minOccurs="0"/>
 *         <element name="FarePriceType" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}FarePriceTypeType" maxOccurs="3"/>
 *         <element name="FareRefText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TextType" minOccurs="0"/>
 *         <element name="FiledFareInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}IndType" minOccurs="0"/>
 *         <element name="NetReportingCodeText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TextType" minOccurs="0"/>
 *         <element name="PaxRefID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}ID_Type" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Price" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}Price2Type" minOccurs="0"/>
 *         <element name="PricingSystemCodeText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TextType" minOccurs="0"/>
 *         <element name="StatisticalCodeText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TextType" minOccurs="0"/>
 *         <element name="TourCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}CodeType" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "FareDetailType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", propOrder = {
    "accountCode",
    "fareComponent",
    "fareIndCode",
    "farePriceType",
...
public class FareDetailType {
     ...
     * 
     */
    @XmlElement(name = "AccountCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "FareComponent", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "FareIndCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "FarePriceType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", required = true)
    protected List<FarePriceTypeType> farePriceType;
    /**
     * Fare reference key, ex: PQ123456
     * 
     */
    @XmlElement(name = "FareRefText", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "FiledFareInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected Boolean filedFareInd;
    /**
     * Code indicating if the transaction is subject to a net reporting arrangement.
     * 
     */
    @XmlElement(name = "NetReportingCodeText", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "PricingSystemCodeText", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected String pricingSystemCodeText;
    /**
     * Code used for domestic or international sales differentiation.
     * 
     */
    @XmlElement(name = "StatisticalCodeText", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected String statisticalCodeText;
    /**
     * Tour Code. Example: ITGF12
     * 
     */
    @XmlElement(name = "TourCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")

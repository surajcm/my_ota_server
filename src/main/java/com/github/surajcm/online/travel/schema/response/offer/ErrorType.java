 ...
 *         <element name="ErrorID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}ID_Type" minOccurs="0"/>
...
@XmlType(name = "ErrorType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", propOrder = {
    "code",
    "descText",
    "errorID",
    "langCode",
...
public class ErrorType {
     ...
     * 
     */
    @XmlElement(name = "ErrorID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")

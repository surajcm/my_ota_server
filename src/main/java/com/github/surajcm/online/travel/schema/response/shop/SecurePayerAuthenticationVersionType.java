 ...
 *       <sequence>
 *         <element name="CardEnrollmentVersionText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TextType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SupportedVersionText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TextType" maxOccurs="unbounded"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "SecurePayerAuthenticationVersionType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", propOrder = {
...
public class SecurePayerAuthenticationVersionType {
     ...
     * 
     */
    @XmlElement(name = "CardEnrollmentVersionText", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected List<String> cardEnrollmentVersionText;
    /**
     * specifies the exact supported 3D-Secure version.
     * 
     */
    @XmlElement(name = "SupportedVersionText", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", required = true)

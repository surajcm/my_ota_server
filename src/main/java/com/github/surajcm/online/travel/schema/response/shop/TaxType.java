 ...
 *       <sequence>
 *         <element name="AddlFiledTaxCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TaxCodeType" minOccurs="0"/>
 *         <element name="AddlTaxCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TaxCodeType" minOccurs="0"/>
 *         <element name="Amount" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}AmountType"/>
 *         <element name="ApproximateInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}IndType" minOccurs="0"/>
 *         <element name="AppTypeCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}CodeType" minOccurs="0"/>
 *         <element name="CollectionInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}IndType" minOccurs="0"/>
 *         <element name="CollectionPointTax" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}CollectionPointTaxType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Country" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}CountryType" minOccurs="0"/>
 *         <element name="CountrySubDivision" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}CountrySubDivisionType" minOccurs="0"/>
 *         <element name="CurConversion" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}CurConversionType" minOccurs="0"/>
 *         <element name="DescText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TextType" minOccurs="0"/>
 *         <element name="FiledAmount" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}AmountType" minOccurs="0"/>
 *         <element name="FiledTaxCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TaxCodeType" minOccurs="0"/>
 *         <element name="QualifierCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TaxQualifierCodeType" minOccurs="0"/>
 *         <element name="RefundInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}IndType" minOccurs="0"/>
 *         <element name="TaxCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TaxCodeType" minOccurs="0"/>
 *         <element name="TaxName" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}NameType" minOccurs="0"/>
 *         <element name="TaxTypeCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TaxTypeCodeType" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "TaxType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", propOrder = {
    "addlFiledTaxCode",
    "addlTaxCode",
    "amount",
    "approximateInd",
...
public class TaxType {
     ...
     * 
     */
    @XmlElement(name = "AddlFiledTaxCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "AddlTaxCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "Amount", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", required = true)
    protected AmountType amount;
    /**
     * When true, this tax amount is approximate.
     * 
     */
    @XmlElement(name = "ApproximateInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected Boolean approximateInd;
    /**
     * Indicates at which point the tax was applied (e.g. S - Sale, D - Departure, A - Arrival, X - Delivery).
     * 
     */
    @XmlElement(name = "AppTypeCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "CollectionInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "CollectionPointTax", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected List<CollectionPointTaxType> collectionPointTax;
    /**
     * A nation with its own government, occupying a particular territory.
     * 
     */
    @XmlElement(name = "Country", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected CountryType country;
    /**
     * An area of land which is a sub-division within a country, such as a state, a county, a canton, a province, etc.
     * 
     */
    @XmlElement(name = "CountrySubDivision", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "FiledAmount", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected AmountType filedAmount;
    /**
     * Internal tax filed type code as determined by the airline.
     * 
     */
    @XmlElement(name = "FiledTaxCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String filedTaxCode;
    /**
     * Used to specify if current, paid, additional taxes Refer to IATA PADIS Code list data element 5305.
     * 
     */
    @XmlElement(name = "QualifierCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "RefundInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected Boolean refundInd;
    /**
     * IATA TTBS Tax Code. Example: AY, GB
     * 
     */
    @XmlElement(name = "TaxCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "TaxName", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "TaxTypeCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    @XmlSchemaType(name = "token")

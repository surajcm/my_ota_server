 ...
 *       <sequence>
 *         <element name="AccountNumber" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}CodeType" minOccurs="0"/>
 *         <element name="Alliance" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}AllianceType" minOccurs="0"/>
 *         <element name="Carrier" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}CarrierType" minOccurs="0"/>
 *         <element name="LoyaltyProgram" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}LoyaltyProgramType"/>
 *         <element name="ProgramCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}CodeType" minOccurs="0"/>
 *         <element name="ProgramName" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}NameType" minOccurs="0"/>
 *         <element name="ProviderName" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}ProperNameType" minOccurs="0"/>
 *         <element name="SignInID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TextType" minOccurs="0"/>
 *         <element name="TierCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}CodeType" minOccurs="0"/>
 *         <element name="TierName" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TextType" minOccurs="0"/>
 *         <element name="TierPriorityText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TextType" minOccurs="0"/>
...
@XmlType(name = "LoyaltyProgramAccountType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", propOrder = {
    "accountNumber",
    "alliance",
    "carrier",
    "loyaltyProgram",
...
public class LoyaltyProgramAccountType {
     ...
     * 
     */
    @XmlElement(name = "AccountNumber", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "Alliance", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "Carrier", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "LoyaltyProgram", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", required = true)
    protected LoyaltyProgramType loyaltyProgram;
    /**
     * Loyalty Program ID: Example: MAM
     * 
     */
    @XmlElement(name = "ProgramCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "ProviderName", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "SignInID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected String signInID;
    /**
     * Loyalty Program tier code.
     * 
     */
    @XmlElement(name = "TierCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "TierName", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected String tierName;
    /**
     * Loyalty Program account priority within the tier (e.g. Platinum, executive, etc.)
     * 
     */
    @XmlElement(name = "TierPriorityText", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")

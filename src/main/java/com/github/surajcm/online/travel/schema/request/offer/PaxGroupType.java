 ...
 *         <element name="IntendedPaxQty" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}QtyType" minOccurs="0"/>
 *         <element name="PaxGroupID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}ID_Type" minOccurs="0"/>
 *         <element name="PaxGroupName" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}PaxGroupNameType" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "PaxGroupType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", propOrder = {
    "contactInfoRefID",
    "intendedPaxQty",
    "paxGroupID",
    "paxGroupName"
...
public class PaxGroupType {
     ...
     * 
     */
    @XmlElement(name = "IntendedPaxQty", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    protected BigDecimal intendedPaxQty;
    /**
     * Uniquely identifies a Passenger Group.
     * 
     */
    @XmlElement(name = "PaxGroupID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "PaxGroupName", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")

 ...
 *       <sequence>
 *         <element name="AgeMeasure" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}MeasureType" minOccurs="0"/>
 ...
 *         <element name="FOID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}FOID_Type" minOccurs="0"/>
 *         <element name="IdentityDoc" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}IdentityDocType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Individual" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}IndividualType" minOccurs="0"/>
 *         <element name="LangUsage" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}LangUsageType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="LoyaltyProgramAccount" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}LoyaltyProgramAccountType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PaxID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}ID_Type"/>
 *         <element name="PaxRefID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}ID_Type" minOccurs="0"/>
 *         <element name="ProfileConsentInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}IndType" minOccurs="0"/>
 *         <element name="ProfileID_Text" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TextType" minOccurs="0"/>
 *         <element name="PTC" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}IATA_PTC_CodeType" minOccurs="0"/>
 *         <element name="RedressCase" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}RedressCaseType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "PaxType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", propOrder = {
    "ageMeasure",
    "birthdate",
...
public class PaxType {
     ...
     * 
     */
    @XmlElement(name = "AgeMeasure", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "FOID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "IdentityDoc", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected List<IdentityDocType> identityDoc;
    /**
     * A single human being as distinct from a group, class, or family.
     * 
     */
    @XmlElement(name = "Individual", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected IndividualType individual;
    /**
     * Language Code representation.
     * 
     */
    @XmlElement(name = "LangUsage", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "PaxID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "ProfileConsentInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected Boolean profileConsentInd;
    /**
     * Passenger Profile ID
     * 
     */
    @XmlElement(name = "ProfileID_Text", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected String profileIDText;
    /**
     * Type code applying to the Passenger which typically drives pricing (e.g. ADT, CHD, etc).
     * 
     */
    @XmlElement(name = "PTC", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "RedressCase", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")

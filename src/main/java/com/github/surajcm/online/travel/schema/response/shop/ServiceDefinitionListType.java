 ...
 *       <sequence>
 *         <element name="ServiceDefinition" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}ServiceDefinitionType" maxOccurs="unbounded"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "ServiceDefinitionListType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", propOrder = {
    "serviceDefinition"
})
public class ServiceDefinitionListType {
     ...
     * 
     */
    @XmlElement(name = "ServiceDefinition", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", required = true)

 ...
 *       <sequence>
 *         <element name="AutoExchInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}IndType" minOccurs="0"/>
 *         <element name="AwardIncludedInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}IndType" minOccurs="0"/>
 *         <element name="AwardOnlyInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}IndType" minOccurs="0"/>
 *         <element name="OverrideCurCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}CurCodeType" minOccurs="0"/>
 *         <element name="SimplePricingInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}IndType" minOccurs="0"/>
 *         <element name="TaxExemption" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}TaxSummaryType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "PricingParameterType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", propOrder = {
    "autoExchInd",
    "awardIncludedInd",
    "awardOnlyInd",
    "overrideCurCode",
...
public class PricingParameterType {
     ...
     * 
     */
    @XmlElement(name = "AutoExchInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    protected Boolean autoExchInd;
    /**
     * When TRUE, award eligible offers to be returned in addition to priced offers.
     * 
     */
    @XmlElement(name = "AwardIncludedInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    protected Boolean awardIncludedInd;
    /**
     * When TRUE, only award eligible offers are requested.
     * 
     */
    @XmlElement(name = "AwardOnlyInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    protected Boolean awardOnlyInd;
    @XmlElement(name = "OverrideCurCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    protected String overrideCurCode;
    /**
     * When TRUE, simple pricing is requested for returned offers.
     * 
     */
    @XmlElement(name = "SimplePricingInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    protected Boolean simplePricingInd;
    /**
     * Tax summary information.
     * 
     */
    @XmlElement(name = "TaxExemption", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")

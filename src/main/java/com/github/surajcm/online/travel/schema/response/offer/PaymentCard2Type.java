...
@XmlType(name = "PaymentCard2Type", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", propOrder = {
    "cardBrandCode",
...
public class PaymentCard2Type {
     ...
     * 
     */
    @XmlElement(name = "CardBrandCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", required = true)
     ...
     * 
     */
    @XmlElement(name = "CardProductTypeCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "CardTypeText", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    ...
    /**
     * Used by Airline if 3D-Secure is required. Airline can specify which version(s) of 3D-Secure is required. Note: 3D-Secure context should be used when the Customer-Seller interaction type is web and/or mobile.
     * 
     */
    @XmlElement(name = "SecurePayerAuthenticationVersion", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")

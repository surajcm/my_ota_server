 ...
 *       <sequence>
 *         <element name="ARNK_Ind" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}IndType" minOccurs="0"/>
 *         <element name="Arrival" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TransportArrivalType"/>
 *         <element name="CabinType" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}CabinTypeType" minOccurs="0"/>
 *         <element name="DatedOperatingLeg" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}DatedOperatingLegType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         <element name="MarketingCarrierInfo" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}DatedMarketingSegmentType"/>
 *         <element name="MarketingCarrierRBD_Code" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}RBD_CodeType" minOccurs="0"/>
 *         <element name="OperatingCarrierInfo" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}DatedOperatingSegmentType" minOccurs="0"/>
 *         <element name="OperatingCarrierRBD_Code" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}RBD_CodeType" minOccurs="0"/>
 *         <element name="PaxSegmentID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}ID_Type"/>
 *         <element name="SecureFlightInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}IndType" minOccurs="0"/>
 *         <element name="SegmentTypeCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}SegmentTypeCodeType" minOccurs="0"/>
...
@XmlType(name = "PaxSegmentType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", propOrder = {
    "arnkInd",
    "arrival",
    "cabinType",
    "datedOperatingLeg",
...
public class PaxSegmentType {
     ...
     * 
     */
    @XmlElement(name = "ARNK_Ind", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "DatedOperatingLeg", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "MarketingCarrierInfo", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", required = true)
    protected DatedMarketingSegmentType marketingCarrierInfo;
    /**
     * Code used to identify a particular RBD (e.g. P, J, W, M, etc.).
     * 
     */
    @XmlElement(name = "MarketingCarrierRBD_Code", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "OperatingCarrierInfo", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected DatedOperatingSegmentType operatingCarrierInfo;
    /**
     * Code used to identify a particular RBD (e.g. P, J, W, M, etc.).
     * 
     */
    @XmlElement(name = "OperatingCarrierRBD_Code", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected String operatingCarrierRBDCode;
    /**
     * Uniquely identifies a Passenger Segment within the context of one message.
     * 
     */
    @XmlElement(name = "PaxSegmentID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", required = true)
     ...
     * 
     */
    @XmlElement(name = "SecureFlightInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "SegmentTypeCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")

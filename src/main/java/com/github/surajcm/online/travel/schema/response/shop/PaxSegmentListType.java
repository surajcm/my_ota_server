 ...
 *       <sequence>
 *         <element name="PaxSegment" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}PaxSegmentType" maxOccurs="unbounded"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "PaxSegmentListType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", propOrder = {
    "paxSegment"
})
public class PaxSegmentListType {
     ...
     * 
     */
    @XmlElement(name = "PaxSegment", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", required = true)

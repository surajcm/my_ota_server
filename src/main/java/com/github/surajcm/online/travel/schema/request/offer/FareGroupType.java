 ...
 *       <sequence>
 *         <element name="FareCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}CodeType"/>
 *         <element name="FareDetail" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}FareDetailType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FareGroupID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}ID_Type"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "FareGroupType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", propOrder = {
    "fareCode",
    "fareDetail",
    "fareGroupID"
})
public class FareGroupType {
     ...
     * 
     */
    @XmlElement(name = "FareCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", required = true)
     ...
     * 
     */
    @XmlElement(name = "FareGroupID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")

 ...
 *       <sequence>
 *         <element name="FareBasisCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}CodeType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FareTypeCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}CodeType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="GroupFareCriteria" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}GroupFareCriteriaType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="NoAdvancePurchaseInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}IndType" minOccurs="0"/>
 *         <element name="NoMaxStayInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}IndType" minOccurs="0"/>
 *         <element name="NoMinStayInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}IndType" minOccurs="0"/>
 *         <element name="NoPenaltyInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}IndType" minOccurs="0"/>
...
@XmlType(name = "FareCriteriaType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", propOrder = {
    "fareBasisCode",
    "fareTypeCode",
    "groupFareCriteria",
...
public class FareCriteriaType {
     ...
     * 
     */
    @XmlElement(name = "GroupFareCriteria", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    protected List<GroupFareCriteriaType> groupFareCriteria;
    /**
     * When true, do not return fares with advance purchase restrictions.
     * 
     */
    @XmlElement(name = "NoAdvancePurchaseInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    protected Boolean noAdvancePurchaseInd;
    /**
     * When true, do not return fares with maximum stay restrictions.
     * 
     */
    @XmlElement(name = "NoMaxStayInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    protected Boolean noMaxStayInd;
    /**
     * When true, do not return fares with minimum stay restrictions.
     * 
     */
    @XmlElement(name = "NoMinStayInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    protected Boolean noMinStayInd;
    /**
     * When true, do not return fares with penalties.
     * 
     */
    @XmlElement(name = "NoPenaltyInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")

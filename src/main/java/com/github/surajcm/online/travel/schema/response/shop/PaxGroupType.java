 ...
 *       <sequence>
 *         <element name="ContactInfoRefID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}ID_Type" maxOccurs="99" minOccurs="0"/>
 *         <element name="IntendedPaxQty" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}QtyType" minOccurs="0"/>
 *         <element name="PaxGroupID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}ID_Type" minOccurs="0"/>
 *         <element name="PaxGroupName" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}PaxGroupNameType" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "PaxGroupType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", propOrder = {
    "contactInfoRefID",
    "intendedPaxQty",
    "paxGroupID",
    "paxGroupName"
...
public class PaxGroupType {
    ...
    /**
     * Reference to the Contact ID of the Group's primary contact(s) within this message.
     * 
     */
     ...
     * 
     */
    @XmlElement(name = "IntendedPaxQty", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected BigDecimal intendedPaxQty;
    /**
     * Uniquely identifies a Passenger Group.
     * 
     */
    @XmlElement(name = "PaxGroupID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "PaxGroupName", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")

 ...
 *       <sequence>
 *         <element name="CardBrandCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}CreditCardVendorCodeType"/>
 *         <element name="CardIssuingCountryCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}CountryCodeType" minOccurs="0"/>
 *         <element name="CardProductTypeCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}CodeType" minOccurs="0"/>
 *         <element name="IssuerIdentificationNumber" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}IIN_NumberType" minOccurs="0"/>
 *         <element name="SecurePaymentAuthenticationVersion" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}SecurePaymentAuthenticationVersionType" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "PaymentCardCriteriaType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", propOrder = {
    "cardBrandCode",
...
public class PaymentCardCriteriaType {
     ...
     * 
     */
    @XmlElement(name = "CardBrandCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", required = true)
    protected String cardBrandCode;
    /**
     * Payment Card issuing country code.
     * 
     */
    @XmlElement(name = "CardIssuingCountryCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
     ...
     * 
     */
    @XmlElement(name = "CardProductTypeCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "IssuerIdentificationNumber", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
     ...
     * 
     */
    @XmlElement(name = "SecurePaymentAuthenticationVersion", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
     ...
     *     {@link SecurePaymentAuthenticationVersionType }
     *     
     * @see #getSecurePaymentAuthenticationVersion()
     */

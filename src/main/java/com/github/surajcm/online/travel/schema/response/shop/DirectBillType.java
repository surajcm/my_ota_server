...
@XmlType(name = "DirectBillType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", propOrder = {
    "contactInfo",
    "orgID",
    "orgName"
})
public class DirectBillType {
     ...
     * 
     */
    @XmlElement(name = "ContactInfo", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected ContactInfoType contactInfo;
    /**
     * The company ID of the corporation to whom remittance should be directed. Example: IBM
     * 
     */
    @XmlElement(name = "OrgID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
     ...
     * 
     */
    @XmlElement(name = "OrgName", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")

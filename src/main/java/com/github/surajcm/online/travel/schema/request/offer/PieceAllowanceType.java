 ...
 *         <element name="ApplicablePartyText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}TextType"/>
 *         <element name="Desc" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}TextType" maxOccurs="99" minOccurs="0"/>
 *         <element name="PieceDimensionAllowance" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}DimensionAllowanceType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="PieceWeightAllowance" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}WeightAllowanceType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="TotalQty" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}QtyType"/>
 *         <element name="TypeText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}TextType" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "PieceAllowanceType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", propOrder = {
    "applicableBagText",
    "applicablePartyText",
    "desc",
...
public class PieceAllowanceType {
     ...
     * 
     */
    @XmlElement(name = "ApplicablePartyText", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", required = true)
     ...
     * 
     */
    @XmlElement(name = "PieceDimensionAllowance", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    protected List<DimensionAllowanceType> pieceDimensionAllowance;
    /**
     * Baggage weight allowance with application information.
     * 
     */
    @XmlElement(name = "PieceWeightAllowance", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    protected List<WeightAllowanceType> pieceWeightAllowance;
    /**
     * Maximum pieces of baggage allowed. Example: 4
     * 
     */
    @XmlElement(name = "TotalQty", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", required = true)
    protected BigDecimal totalQty;
    /**
     * Type of bag. Example: Golf Equipment, Fishing Bag, Car Seat, etc.
     * 
     */
    @XmlElement(name = "TypeText", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")

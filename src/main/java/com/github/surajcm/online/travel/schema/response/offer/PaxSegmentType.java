 ...
 *       <sequence>
 *         <element name="ARNK_Ind" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}IndType" minOccurs="0"/>
 *         <element name="Arrival" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}TransportArrivalType"/>
 *         <element name="CabinType" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}CabinTypeType" minOccurs="0"/>
 *         <element name="DatedOperatingLeg" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}DatedOperatingLegType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Dep" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}TransportDepType"/>
 *         <element name="Duration" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}DurationType" minOccurs="0"/>
 ...
 *         <element name="MarketingCarrierInfo" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}DatedMarketingSegmentType"/>
 *         <element name="MarketingCarrierRBD_Code" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}RBD_CodeType" minOccurs="0"/>
 *         <element name="OperatingCarrierInfo" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}DatedOperatingSegmentType" minOccurs="0"/>
 *         <element name="OperatingCarrierRBD_Code" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}RBD_CodeType" minOccurs="0"/>
 *         <element name="PaxSegmentID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}ID_Type"/>
 *         <element name="SecureFlightInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}IndType" minOccurs="0"/>
 *         <element name="SegmentTypeCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}SegmentTypeCodeType" minOccurs="0"/>
 *         <element name="TicketlessInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}IndType" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "PaxSegmentType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", propOrder = {
    "arnkInd",
    "arrival",
    "cabinType",
    "datedOperatingLeg",
...
public class PaxSegmentType {
     ...
     * 
     */
    @XmlElement(name = "ARNK_Ind", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    protected Boolean arnkInd;
    /**
     * The action or process of arriving of a transport vehicle in any place or location.
     * 
     */
    @XmlElement(name = "Arrival", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", required = true)
     ...
     * 
     */
    @XmlElement(name = "CabinType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
     ...
     * 
     */
    @XmlElement(name = "DatedOperatingLeg", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
     ...
     * 
     */
    @XmlElement(name = "Dep", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", required = true)
    protected TransportDepType dep;
    /**
     * Total segment time including the combined air time and connection times of any legs.
     * 
     */
    @XmlElement(name = "Duration", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
     ...
     * 
     */
    @XmlElement(name = "MarketingCarrierInfo", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", required = true)
    protected DatedMarketingSegmentType marketingCarrierInfo;
    /**
     * Code used to identify a particular RBD (e.g. P, J, W, M, etc.).
     * 
     */
    @XmlElement(name = "MarketingCarrierRBD_Code", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
     ...
     * 
     */
    @XmlElement(name = "OperatingCarrierInfo", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    protected DatedOperatingSegmentType operatingCarrierInfo;
    /**
     * Code used to identify a particular RBD (e.g. P, J, W, M, etc.).
     * 
     */
    @XmlElement(name = "OperatingCarrierRBD_Code", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "PaxSegmentID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "SecureFlightInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
     ...
     * 
     */
    @XmlElement(name = "SegmentTypeCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "TicketlessInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")

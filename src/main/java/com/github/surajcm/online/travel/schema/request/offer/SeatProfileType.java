 ...
 *         <element name="MarketingInfo" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}DescType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SeatKeywords" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}KeyValuePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SeatPitchMeasure" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}MeasureType" minOccurs="0"/>
 *         <element name="SeatProfileID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}ID_Type"/>
 *         <element name="SeatWidthMeasure" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}MeasureType" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "SeatProfileType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", propOrder = {
    "characteristicCode",
    "marketingInfo",
    "seatKeywords",
    "seatPitchMeasure",
...
public class SeatProfileType {
     ...
     * 
     */
    @XmlElement(name = "MarketingInfo", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    protected List<DescType> marketingInfo;
    /**
     * Key value pair used by airlines to further describe seat characteristics.
     * 
     */
    @XmlElement(name = "SeatKeywords", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    protected List<KeyValuePropertyType> seatKeywords;
    /**
     * Measure of a given seat's pitch.
     * 
     */
    @XmlElement(name = "SeatPitchMeasure", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    protected MeasureType seatPitchMeasure;
    /**
     * Unique identifier associated to this Seat Profile.
     * 
     */
    @XmlElement(name = "SeatProfileID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "SeatWidthMeasure", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")

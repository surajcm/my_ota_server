 ...
 *         <element name="ConversionRate" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}RateType"/>
 *         <element name="LocalAmount" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}AmountType"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "CurConversionType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", propOrder = {
    "amount",
    "conversionRate",
    "localAmount"
})
public class CurConversionType {
     ...
     * 
     */
    @XmlElement(name = "ConversionRate", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", required = true)
    protected RateType conversionRate;
    /**
     * Amount and currency as specified by the local Country.
     * 
     */
    @XmlElement(name = "LocalAmount", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", required = true)

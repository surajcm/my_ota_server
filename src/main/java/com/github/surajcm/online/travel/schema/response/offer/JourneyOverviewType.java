 ...
 *       <sequence>
 *         <element name="JourneyPriceClass" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}JourneyPriceClassType" maxOccurs="unbounded"/>
...
@XmlType(name = "JourneyOverviewType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", propOrder = {
    "journeyPriceClass",
    "priceClassRefID"
})
public class JourneyOverviewType {
     ...
     * 
     */
    @XmlElement(name = "JourneyPriceClass", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", required = true)

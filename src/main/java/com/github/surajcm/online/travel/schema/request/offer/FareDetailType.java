 ...
 *       <sequence>
 *         <element name="AccountCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}CodeType" minOccurs="0"/>
 *         <element name="FareCalculationInfo" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}FareCalculationInfoType" minOccurs="0"/>
 *         <element name="FareComponent" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}FareComponentType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="FareIndCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}CodeType" minOccurs="0"/>
 *         <element name="FarePriceType" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}FarePriceTypeType" maxOccurs="3"/>
 *         <element name="FareRefText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}TextType" minOccurs="0"/>
 *         <element name="FareWaiver" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}FareWaiverType" maxOccurs="5" minOccurs="0"/>
 *         <element name="FiledFareInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}IndType" minOccurs="0"/>
 *         <element name="NetReportingCodeText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}TextType" minOccurs="0"/>
 ...
 *         <element name="Price" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}Price2Type" minOccurs="0"/>
 *         <element name="PricingSystemCodeText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}TextType" minOccurs="0"/>
 *         <element name="StatisticalCodeText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}TextType" minOccurs="0"/>
 *         <element name="TourCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}CodeType" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "FareDetailType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", propOrder = {
    "accountCode",
    "fareCalculationInfo",
    "fareComponent",
    "fareIndCode",
...
public class FareDetailType {
     ...
     * 
     */
    @XmlElement(name = "AccountCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
     ...
     * 
     */
    @XmlElement(name = "FareCalculationInfo", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
     ...
     * 
     */
    @XmlElement(name = "FareComponent", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
     ...
     * 
     */
    @XmlElement(name = "FareIndCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "FarePriceType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", required = true)
    protected List<FarePriceTypeType> farePriceType;
    /**
     * Fare reference key, ex: PQ123456
     * 
     */
    @XmlElement(name = "FareRefText", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    protected String fareRefText;
    /**
     * Validating carrier-assigned fare rule modification or override information.
     * 
     */
    @XmlElement(name = "FareWaiver", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
     ...
     * 
     */
    @XmlElement(name = "FiledFareInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    protected Boolean filedFareInd;
    /**
     * Code indicating if the transaction is subject to a net reporting arrangement.
     * 
     */
    @XmlElement(name = "NetReportingCodeText", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
     ...
     * 
     */
    @XmlElement(name = "PricingSystemCodeText", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    protected String pricingSystemCodeText;
    /**
     * Code used for domestic or international sales differentiation.
     * 
     */
    @XmlElement(name = "StatisticalCodeText", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    protected String statisticalCodeText;
    /**
     * Tour Code. Example: ITGF12
     * 
     */
    @XmlElement(name = "TourCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the fareWaiver property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the fareWaiver property.
     */
    public List<FareWaiverType> getFareWaiver() {
        if (fareWaiver == null) {
            fareWaiver = new ArrayList<>();
        }

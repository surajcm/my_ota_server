 ...
 *       <sequence>
 *         <element name="DatedOperatingLeg" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}DatedOperatingLegType"/>
 *         <element name="PaxLegID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}ID_Type" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "PaxLegType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", propOrder = {
    "datedOperatingLeg",
    "paxLegID"
})
public class PaxLegType {
     ...
     * 
     */
    @XmlElement(name = "DatedOperatingLeg", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", required = true)
    protected DatedOperatingLegType datedOperatingLeg;
    /**
     * Uniquely identifies a Passenger Leg within the context of one message.
     * 
     */
    @XmlElement(name = "PaxLegID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")

 ...
 *       <sequence>
 *         <element name="CharacteristicCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}SeatCharacteristicCodeType" maxOccurs="99" minOccurs="0"/>
 *         <element name="MarketingInfo" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}DescType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SeatKeywords" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}KeyValuePropertyType" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="SeatPitchMeasure" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}MeasureType" minOccurs="0"/>
 *         <element name="SeatProfileID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}ID_Type"/>
 *         <element name="SeatWidthMeasure" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}MeasureType" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "SeatProfileType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", propOrder = {
    "characteristicCode",
    "marketingInfo",
    "seatKeywords",
    "seatPitchMeasure",
...
public class SeatProfileType {
     ...
     * 
     */
    @XmlElement(name = "CharacteristicCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
     ...
     * 
     */
    @XmlElement(name = "MarketingInfo", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    protected List<DescType> marketingInfo;
    /**
     * Key value pair used by airlines to further describe seat characteristics.
     * 
     */
    @XmlElement(name = "SeatKeywords", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    protected List<KeyValuePropertyType> seatKeywords;
    /**
     * Measure of a given seat's pitch.
     * 
     */
    @XmlElement(name = "SeatPitchMeasure", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    protected MeasureType seatPitchMeasure;
    /**
     * Unique identifier associated to this Seat Profile.
     * 
     */
    @XmlElement(name = "SeatProfileID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "SeatWidthMeasure", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")

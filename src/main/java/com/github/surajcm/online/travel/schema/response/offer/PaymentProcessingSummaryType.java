 ...
 *         <element name="Desc" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}DescType" minOccurs="0"/>
 *         <element name="OrderAssociation" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}OrderAssociationType" minOccurs="0"/>
 *         <element name="PaymentID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}ID_Type" minOccurs="0"/>
 *         <element name="PaymentMethod" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}PaymentMethodType"/>
 *         <element name="PaymentRefID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}ID_Type" minOccurs="0"/>
 *         <element name="PaymentStatusCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}PaymentStatusCodeType" minOccurs="0"/>
 *         <element name="PriceVarianceAmount" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}AmountType" minOccurs="0"/>
 *         <element name="PriceVarianceRule" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}PriceVarianceRuleType" minOccurs="0"/>
 ...
 *         <element name="SurchargeAmount" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}AmountType" minOccurs="0"/>
 *         <element name="TypeCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}PaymentMethodCodeType" minOccurs="0"/>
...
@XmlType(name = "PaymentProcessingSummaryType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", propOrder = {
    "amount",
    "contactInfoRefID",
    "desc",
    "orderAssociation",
...
public class PaymentProcessingSummaryType {
     ...
     * 
     */
    @XmlElement(name = "OrderAssociation", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    protected OrderAssociationType orderAssociation;
    /**
     * Uniquely identifies payment information within a message.
     * 
     */
    @XmlElement(name = "PaymentID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "PaymentMethod", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", required = true)
     ...
     * 
     */
    @XmlElement(name = "PaymentRefID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "PaymentStatusCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "PriceVarianceAmount", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
     ...
     * 
     */
    @XmlElement(name = "PriceVarianceRule", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
     ...
     * 
     */
    @XmlElement(name = "SurchargeAmount", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    protected AmountType surchargeAmount;
    /**
     * The payment method type. Examples: Credit Card, Cash.
     * 
     */
    @XmlElement(name = "TypeCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")

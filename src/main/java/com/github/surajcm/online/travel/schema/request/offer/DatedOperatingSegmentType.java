 ...
 *       <sequence>
 *         <element name="CarrierDesigCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}AirlineDesigCodeType" minOccurs="0"/>
 *         <element name="CarrierName" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}CountryCodeType" minOccurs="0"/>
 *         <element name="DisclosureRefID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}ID_Type" minOccurs="0"/>
 *         <element name="OperatingCarrierFlightNumberText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}FlightNumberTextType" minOccurs="0"/>
 *         <element name="OperationalSuffixText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}OperationalSuffixTextType" minOccurs="0"/>
 *         <element name="RBD_Code" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}RBD_CodeType" minOccurs="0"/>
 *         <element name="StatusCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}CodeType" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "DatedOperatingSegmentType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", propOrder = {
    "carrierDesigCode",
    "carrierName",
    "disclosureRefID",
...
public class DatedOperatingSegmentType {
     ...
     * 
     */
    @XmlElement(name = "CarrierDesigCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
     ...
     * 
     */
    @XmlElement(name = "CarrierName", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "DisclosureRefID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
     ...
     * 
     */
    @XmlElement(name = "OperatingCarrierFlightNumberText", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
     ...
     * 
     */
    @XmlElement(name = "OperationalSuffixText", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    protected String operationalSuffixText;
    /**
     * Code used to identify a particular RBD (e.g. P, J, W, M, etc.).
     * 
     */
    @XmlElement(name = "RBD_Code", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")

 ...
 *       <sequence>
 *         <element name="AvailInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}IndType" minOccurs="0"/>
 *         <element name="ChargeableInd" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}IndType" minOccurs="0"/>
 *         <element name="MaximumStopOversPermittedQty" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}QtyType" minOccurs="0"/>
 *         <element name="PaxRefID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}ID_Type" minOccurs="0"/>
 *         <element name="StopOverLocation" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS}StopOverLocationType" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "StopOverRestrictionsType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS", propOrder = {
    "availInd",
    "chargeableInd",
...
public class StopOverRestrictionsType {
     ...
     * 
     */
    @XmlElement(name = "AvailInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
    protected Boolean availInd;
    /**
     * An indicator to identify if the Stopover has an associated fee.
     * 
     */
    @XmlElement(name = "ChargeableInd", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
     ...
     * 
     */
    @XmlElement(name = "MaximumStopOversPermittedQty", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")
     ...
     * 
     */
    @XmlElement(name = "StopOverLocation", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRS")

...
@XmlType(name = "OrgType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", propOrder = {
    "contactInfoRefID",
    "name",
    "orgID"
})
public class OrgType {
     ...
     * 
     */
    @XmlElement(name = "OrgID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")

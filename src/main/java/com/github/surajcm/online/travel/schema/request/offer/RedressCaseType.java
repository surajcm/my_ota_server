 ...
 *       <sequence>
 *         <element name="Country" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}CountryType"/>
 *         <element name="CountryCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}CountryCodeType"/>
 *         <element name="ProgramName" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}NameType" minOccurs="0"/>
 *         <element name="RedressCaseID" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ}RedressID_Type"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "RedressCaseType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", propOrder = {
    "country",
    "countryCode",
    "programName",
    "redressCaseID"
...
public class RedressCaseType {
     ...
     * 
     */
    @XmlElement(name = "Country", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", required = true)
    protected CountryType country;
    /**
     * ISO Country Code (can be extended by bilateral agreement in case of exceptions, e.g. Kosovo). Examples: US, FR.
     * 
     */
    @XmlElement(name = "CountryCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", required = true)
     ...
     * 
     */
    @XmlElement(name = "RedressCaseID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_OfferPriceRQ", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")

 ...
 *       <sequence>
 *         <element name="PaymentFeeAmountRangeMaximumAmount" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}AmountType" minOccurs="0"/>
 *         <element name="PaymentFeeAmountRangeMinimumAmount" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}AmountType" minOccurs="0"/>
 *         <element name="PaymentFeePercentageRangeMaximumPercent" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}PercentType" minOccurs="0"/>
 *         <element name="PaymentFeePercentageRangeMinimumPercent" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}PercentType" minOccurs="0"/>
 *         <element name="PaymentFeeRoundingNumberOfDecimalsNumber" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}NumberType" minOccurs="0"/>
 *         <element name="PaymentFeeRoundingPrecisionCode" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}RoundingPrecisionCodeType" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "SurchargeInfoType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", propOrder = {
...
public class SurchargeInfoType {
     ...
     * 
     */
    @XmlElement(name = "PaymentFeeAmountRangeMaximumAmount", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected AmountType paymentFeeAmountRangeMaximumAmount;
    /**
     * Minimum Amount of a Fee range of a payment method
     * 
     */
    @XmlElement(name = "PaymentFeeAmountRangeMinimumAmount", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected AmountType paymentFeeAmountRangeMinimumAmount;
    /**
     * Maximum Percentage value of a Fee range of a payment method
     * 
     */
    @XmlElement(name = "PaymentFeePercentageRangeMaximumPercent", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected BigDecimal paymentFeePercentageRangeMaximumPercent;
    /**
     * Minimum Percentage value of a Fee range of a payment method
     * 
     */
    @XmlElement(name = "PaymentFeePercentageRangeMinimumPercent", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected BigDecimal paymentFeePercentageRangeMinimumPercent;
    /**
     * Number of decimals of fee rounding
     * 
     */
    @XmlElement(name = "PaymentFeeRoundingNumberOfDecimalsNumber", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected BigDecimal paymentFeeRoundingNumberOfDecimalsNumber;
    /**
     * precision of fee rounding
     * 
     */
    @XmlElement(name = "PaymentFeeRoundingPrecisionCode", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")

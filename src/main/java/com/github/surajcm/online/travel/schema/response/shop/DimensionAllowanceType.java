 ...
 *         <element name="BaggageDimensionCategory" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TextType"/>
 *         <element name="DescText" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}TextType" maxOccurs="99" minOccurs="0"/>
 *         <element name="MaxMeasure" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}MeasureType"/>
 *         <element name="MinMeasure" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}MeasureType" minOccurs="0"/>
 *         <element name="Qty" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}QtyType" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "DimensionAllowanceType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", propOrder = {
    "applicableBagText",
    "applicablePartyText",
...
public class DimensionAllowanceType {
     ...
     * 
     */
    @XmlElement(name = "BaggageDimensionCategory", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", required = true)
     ...
     * 
     */
    @XmlElement(name = "MaxMeasure", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", required = true)
    protected MeasureType maxMeasure;
    /**
     * Minimum dimensions value. Example: 62 Notes: Linear measurement = length + width + height
     * 
     */
    @XmlElement(name = "MinMeasure", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")
    protected MeasureType minMeasure;
    /**
     * Quantity of pieces allowed with these measurements.
     * 
     */
    @XmlElement(name = "Qty", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")

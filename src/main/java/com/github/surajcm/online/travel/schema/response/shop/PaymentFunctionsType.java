...
@XmlType(name = "PaymentFunctionsType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", propOrder = {
    "paymentSupportedMethod"
})
public class PaymentFunctionsType {

    @XmlElement(name = "PaymentSupportedMethod", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS")

 ...
 *       <sequence>
 *         <element name="PaxJourney" type="{http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS}PaxJourneyType" maxOccurs="unbounded"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "PaxJourneyListType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", propOrder = {
    "paxJourney"
})
public class PaxJourneyListType {
     ...
     * 
     */
    @XmlElement(name = "PaxJourney", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", required = true)

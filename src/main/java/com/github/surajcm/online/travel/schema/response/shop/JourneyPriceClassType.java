...
@XmlType(name = "JourneyPriceClassType", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", propOrder = {
    "paxJourneyRefID",
    "priceClassRefID"
})
public class JourneyPriceClassType {
     ...
     * 
     */
    @XmlElement(name = "PaxJourneyRefID", namespace = "http://www.iata.org/IATA/2015/00/2019.2/IATA_AirShoppingRS", required = true)
